...
import Queue from './svg-sprite/queue.js';
import Layouter from './svg-sprite/layouter.js';
import svgo from './svg-sprite/transform/svgo.js';
import ArgumentError from './svg-sprite/errors/argument-error.js';
import {
  isFunction,
  isObject,
  isPlainObject,
  ...
  runWaterfall,
  runParallelLimit,
} from './svg-sprite/utils/index.js';
